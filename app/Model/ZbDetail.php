...
class ZbDetail extends Model
{
    ...
    protected $fillable = [
            'BJDJ', 'BGDJID', 'DJZT', 'ZY', 'SQJE1', 'JE', 'WH', 'DZKDM', 'DZKMC', 'YSDWDM', 'YSDWMC', 'YSKMDM', 'YSKMMC', 'JFLXDM', 'JFLXMC', 'XMDM', 'XMMC', 'ZJXZDM', 'ZJXZMC', 'ZBLYDM', 'ZBLYMC', 'ZCLXDM', 'ZCLXMC', 'ZFFSDM', 'ZFFSMC', 'LR_RQ', 'LRR', 'ZBID', 'SKR', 'SKRKHYH', 'SKZH', ];
}
