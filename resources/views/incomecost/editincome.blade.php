  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <div class="panel-body">
       ...
       {!! Form::model($income,['method' => 'PATCH', 'route' => ['income.update', $income->id], 'class' => 'form-horizontal']) !!}
          {{ csrf_field() }}
           ...
           <div class="form-group{{ $errors->has('xingzhi') ? ' has-error' : '' }}">
               ...
               {!! Form::text('xingzhi', null, ['class' => 'form-control']) !!}
